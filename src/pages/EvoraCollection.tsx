...
interface EvoraCollectionProps {
    dresses: Dress[];
    onOpenDetails: (dress: Dress) => void;
}

export default function EvoraCollection({ dresses, onOpenDetails }: EvoraCollectionProps) {
    return (
        <div className="bg-[#FAF8F5] min-h-screen pb-20">
            ...
            <div className="relative h-[70vh] w-full overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-20 text-center px-6 mt-20 animate-fadeInUp-slow" style={{ animationDelay: '0.2s' }}>
                    <span className="block text-[10px] md:text-[11px] uppercase tracking-[0.4em] font-bold text-white/80 mb-6 drop-shadow-md">Sclipiri Eterice</span>
                    ...
                    <p className="font-light text-white/90 text-base md:text-lg leading-[2] max-w-xl mx-auto drop-shadow-md">
                        O simfonie a texturilor fine și a strălucirii discrete.
                        Concepută pentru mireasa care își dorește să strălucească la propriu.
                    </p>
                </div>
            </div>
