...
interface EliseCollectionProps {
    dresses: Dress[];
    onOpenDetails: (dress: Dress) => void;
}

export default function EliseCollection({ dresses, onOpenDetails }: EliseCollectionProps) {
    return (
        <div className="bg-[#FAF8F5] min-h-screen pb-20">
            ...
            <div className="relative h-[70vh] w-full overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-20 text-center px-6 mt-20 animate-fadeInUp-slow" style={{ animationDelay: '0.2s' }}>
                    <span className="block text-[10px] md:text-[11px] uppercase tracking-[0.4em] font-bold text-white/80 mb-6 drop-shadow-md">Noblețe Clasică</span>
                    ...
                    <p className="font-light text-white/90 text-base md:text-lg leading-[2] max-w-xl mx-auto drop-shadow-md">
                        Rafinamentul unei siluete clasice în tafta perlată.
                        O eleganță atemporală ce pune în valoare noblețea fiecărei mișcări.
                    </p>
                </div>
            </div>
