                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-4">
                        ...
                        <div className="flex gap-4 mt-8">
                            <a href="https://instagram.com/fya_robes" target="_blank" rel="noreferrer" className="w-10 h-10 border border-[#3a3a3a] rounded-full flex items-center justify-center text-[#959595] hover:text-white hover:border-white transition-all">
                            ...
                            <a href="https://facebook.com/fyarobes" target="_blank" rel="noreferrer" className="w-10 h-10 border border-[#3a3a3a] rounded-full flex items-center justify-center text-[#959595] hover:text-white hover:border-white transition-all">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                            </a>
                            <a href="https://tiktok.com/@fyarobes" target="_blank" rel="noreferrer" className="w-10 h-10 border border-[#3a3a3a] rounded-full flex items-center justify-center text-[#959595] hover:text-white hover:border-white transition-all">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        <ul className="space-y-3 text-sm font-light text-[#959595]">
                            ...
                            <li><Link to="/evora" className="hover:text-white transition-colors">Evora</Link></li>
                            <li><Link to="/elise" className="hover:text-white transition-colors">Elise</Link></li>
                        </ul>
                    </div>
